...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    public Result<?> resetPassword(String username, String oldpassword, String newpassword, String confirmpassword) {
        ...
        userMapper.update(new SysUser().setPassword(password), new LambdaQueryWrapper<SysUser>().eq(SysUser::getId, user.getId()));
...
//			}
	...
	@Override
	public IPage<SysUser> getUserByGoodId(Page<SysUser> page, String goodId, String username) {
		return userMapper.getUserByGoodId(page, goodId, username);
	}
...
//		}
	...
	@Override
	public int updatePersonalData(SysUser user, String currentUserId) {
		return userMapper.updatePersonalData(user, currentUserId);
	}
